...
export default function ProductTable({ CartData, onCheckOutClick, setTotalAmountToPay }) {
    ...
    React.useEffect(() => {
        ...
        setInvoiceTotal(
            (invoiceSubtotalData + ((tax / 100) * invoiceSubtotalData))
            -
        ...
        <TableContainer component={Paper}>
            <Table sx={{ minWidth: 700 }} aria-label="spanning table">
                ...
                <TableBody>
                    ...
                    <TableRow>
                        <TableCell rowSpan={4} />
                        <TableCell align="center" colSpan={4} sx={{ fontWeight: "bold" }}>Subtotal</TableCell>
                        <TableCell align="right" sx={{ fontWeight: "600" }}>{ccyFormat(invoiceSubtotal)}</TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell align="center" colSpan={3} sx={{ paddingLeft: '14vw', fontWeight: "bold" }}>Tax</TableCell>
                        <TableCell onClick={handleTaxClick} sx={{ textDecoration: "underLine", backgroundColor: "#F6EA89" }}>
                            {isTaxEditing ? (
                                <TextField
                                    sx={{ width: "50px" }}
                                    id="standard-basic"
                        ...
                        <TableCell align="right" sx={{ fontWeight: "600" }}>{ccyFormat(invoiceTaxes)}</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                        <TableCell align="center" colSpan={4} sx={{ fontWeight: "900" }}>Total</TableCell>
